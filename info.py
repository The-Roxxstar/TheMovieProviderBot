...
DATABASE_NAME = environ.get('DATABASE_NAME', "ROX")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Verify
VERIFY = bool(environ.get('VERIFY', False)) # Verification On ( True ) / Off ( False )
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/i_popcorn_movie_update/31')  # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/I_PapCornBetaGroup')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002245922111')) #Log channel id ( make sure bot is admin )
